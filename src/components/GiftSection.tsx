...
import { Gift, Sparkles, ArrowLeft, Check, Shield } from 'lucide-react';
  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      <div className="bg-gradient-to-br from-[#2B211B] via-[#4A3326] to-[#2B211B] text-[#F8F3EC] rounded-3xl p-8 sm:p-12 md:p-16 border border-[#C9A76A]/40 shadow-2xl relative overflow-hidden">
        ...
        <div className="absolute -top-24 -left-24 w-96 h-96 bg-[#C9A76A]/10 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute -bottom-24 -right-24 w-96 h-96 bg-[#B78A5C]/15 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-7 text-right space-y-6">
            ...
            <p className="text-sm sm:text-base text-[#F8F3EC]/80 font-light leading-relaxed max-w-2xl">
              ابتكرنا صناديق هدايا فاخرة مغلفة بنسيج المخمل والحرير، تتزين بالحفر الذهبي والنقوش العمانية التاريخية، وتضم أواني ضيافة نحاسية معتقة مع أنقى خلطات البن العماني والتمور الفاخرة.
            </p>

            {/* Included Box Features */}
            <div className="space-y-3 pt-2 text-xs sm:text-sm text-[#F8F3EC]/90 font-light">
            ...
            <div className="pt-4 flex flex-wrap items-center gap-4">
              {giftProduct && (
                <button
                  ...
                  className="px-8 py-4 rounded-full bg-gradient-to-r from-[#B78A5C] to-[#C9A76A] text-[#2B211B] font-bold text-sm hover:shadow-xl hover:shadow-[#C9A76A]/20 transition-all flex items-center gap-2"
                >
          ...
          <div className="lg:col-span-5 relative">
            <div className="rounded-3xl overflow-hidden border-2 border-[#C9A76A]/50 shadow-2xl group">
              <img
                src="/src/assets/images/luxury_gift_box_1785262908848.jpg"
              ...
              <div className="absolute bottom-6 right-6 left-6 text-right">
                ...
                <h4 className="font-amiri text-2xl font-bold text-[#F8F3EC]">
